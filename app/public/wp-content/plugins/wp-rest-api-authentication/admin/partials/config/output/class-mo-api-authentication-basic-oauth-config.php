...
class Mo_API_Authentication_Admin_Basic_Auth_Config {
	...
	public static function mo_api_auth_configuration_output() {
		...
		<div id="mo_api_authentication_support_tokenapi" class="mo_api_authentication_common_div_css">
			<div>
				...
				<table class="mo_api_authentication_settings_table">
					...
					<tr>
						<td>Client ID : </td>&nbsp;
						<td><input readonly id="mo_api_auth_client_id_value" style="width:350px; border: 0;" type="textbox" value="<?php echo get_option('mo_api_auth_clientid'); ?>"></td>
					</tr>
					<tr>
						<td>Client Secret : </td>&nbsp;
						<td><input readonly id="mo_api_auth_client_secret_value" style="width:350px; border: 0;" type="textbox" value="<?php echo get_option('mo_api_auth_clientsecret'); ?>"></td>
					</tr>
					<tr>
						<td></td>
						<td>
		...
		<div id="mo_api_authentication_support_basicoauth" class="mo_api_authentication_common_div_css">
			<h3>API Reference for Basic Auth : </h3>
			<table class="mo_api_authentication_settings_table">
				<tr>
							...
							<table class="mo_api_authentication_settings_table">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php if( $basic_auth_key == 'uname_pass' ){?>
												curl -H "Authorization:Basic <b>base64encoded&lt;username:password&gt;</b>" -X GET <?php echo get_home_url();?>/wp-json/wp/v2/posts
											<?php } elseif( $basic_auth_key == 'cid_secret' ){
												...
												?>
												curl -H "Authorization:Basic <?php echo base64_encode($str); ?>" -X GET <?php echo get_home_url();?>/wp-json/wp/v2/posts
											<?php 
											} ?>
										</td>
									</tr>

					...
					<table class="mo_settings_table">
						<tr>
							...
							<td><input class="mo_table_textbox" type="email" name="email"
								...
								value="<?php echo get_option('mo_api_authentication_admin_email');?>" />
							</td>
						</tr>
						<tr class="hidden">
						...
						<tr  class="hidden">
							<td><b>&nbsp;&nbsp;Phone number :</b></td>
							 <td><input class="" type="text" name="phone" pattern="[\+]?([0-9]{1,4})?\s?([0-9]{7,12})?" id="phone" title="Phone with country code eg. +1xxxxxxxxxx" placeholder="Phone with country code eg. +1xxxxxxxxxx" value="<?php echo get_option('mo_api_authentication_admin_phone');?>" />
...
function mo_api_authentication_show_customer_info() {
	...
	<div class="mo_table_layout" >
		...
		<tr>
			...
			<td style="width:55%; padding: 10px;"><?php echo get_option( 'mo_api_authentication_admin_email' ); ?></td>
		</tr>
		<tr>
			<td style="width:45%; padding: 10px;">Customer ID</td>
			<td style="width:55%; padding: 10px;"><?php echo get_option( 'mo_api_authentication_admin_customer_key' ) ?></td>
		</tr>
		</table>
		<br /><br />

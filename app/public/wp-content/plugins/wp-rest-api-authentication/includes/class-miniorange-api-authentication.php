...
class Miniorange_api_authentication {
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-miniorange-api-authentication-public.php';
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Miniorange_api_authentication_Public( $this->get_plugin_name(), $this->get_version() );
